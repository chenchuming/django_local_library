...
def index(request):
    ...
    num_genres=Genre.objects.count() # count of genres
    num_wild_book=Book.objects.filter(title__icontains='wild').count
    ...
    return render(
        ...
        context={'num_books':num_books, 'num_instances':num_instances, 'num_instances_available':num_instances_available, \
            'num_authors':num_authors, 'num_genres':num_genres, 'num_wild_book':num_wild_book, 'num_visits':num_visits}
    )
